 ...
 * 아래에서 from "module/myModule03_ESM.mjs"와 같이 지정하면 모듈을 찾지 못한다.
 ...
 **/
import { PI, helloUser, helloTest } from "./module/myModule03_ESM.mjs";
console.log("PI : ", PI);
console.log(helloUser("어머나"));
console.log(helloTest('왕빛나'));